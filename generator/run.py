...
if args.analysis_type == "retrieval_recall":
    ...
    for ret_acc in ret_acc_list:
        cmd = f'python generator/generate.py --model {args.model} --dataset {args.dataset} --retriever {args.retriever} --analysis_type {args.analysis_type} --n {args.n} --ret_acc {ret_acc}'
