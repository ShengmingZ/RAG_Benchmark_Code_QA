...
if __name__ == '__main__':
    ...
    # in_program_call = '--model gpt-3.5-turbo-0125 --temperature 0 --n 1 --dataset conala --retriever openai-embedding --analysis_type prompt_method --prompt_type cot --action gene_responses'
    args = generate_config(in_program_call)
