...
if __name__ == '__main__':
    ...
    # in_program_call = '--model codellama-13b-instruct --temperature 0 --n 1 --dataset pandas_numpy_eval --retriever openai-embedding --analysis_type prompt_method --prompt_type plan_and_solve'
    args = generate_config(in_program_call)
